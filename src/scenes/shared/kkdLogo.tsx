...
const KKDLogo = ({ x, y }: props) => {
    ...
    return (
        <div className={themeMode}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 422.15 336" width={x} height={y} fill={color} >
                <g id="K1-S0">
                    <path
