...
const KanjiBlock = ({ entry }: Props) => {
    ...
    return (
        <div className={`${themeMode} bg-gradient-to-br from-Theme-kanjiCardbg1 to-Theme-kanjiCardbg2 rounded-2xl m-2 p-2 relative max-w-[1000px] flex md:flex-row flex-col justify-start items-center`}>
            ...
            <div className="flex flex-col justify-center m-2 sm:p-5 p-2">
                <div className='flex justify-center text-Theme-text-color text-2xl font-bold m-2 p-2'>
